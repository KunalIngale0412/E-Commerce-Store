  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger className="relative">
        <BsCart2 size={20} className="text-gray-500 hover:text-primary"  />
      ...
      <SheetContent className='sm:max-w-[450px] w-full'>
        ...
        <div className="h-[calc(100vh-40px)] pb-10 ">
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {product.qty} X {product.sellingPrice.toLocaleString("en-IN", {
                      style: "currency",
                      currency: "INR",
                    })}
                  </p>
          ...
          <div className="h-40 border-t pt-5 px-2">
