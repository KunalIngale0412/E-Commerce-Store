  ...
  try {
    ...
    if(globalFilters){
      matchQuery["$or"] = [
        ...
        {"categoryData.name":{$regex: globalFilters, $options: 'i'}}, // here i means insensitive it will not see the lowercase or uppercase letter it directly match the slug and filter it 
        {
          $expr:{
            $regexMatch:{
              input: {$toString:"$mrp"},
