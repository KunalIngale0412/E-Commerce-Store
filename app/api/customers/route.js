  ...
  try {
    ...
    if(globalFilters){
      matchQuery["$or"] = [
        ...
        {address:{$regex: globalFilters, $options: 'i'}}, // here i means insensitive it will not see the lowercase or uppercase letter it directly match the name and filter it   
        {isEmailVerfied:{$regex: globalFilters, $options: 'i'}}, // here i means insensitive it will not see the lowercase or uppercase letter it directly match the name and filter it   
