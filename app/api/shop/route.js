...
export async function GET(request) {
    try {
        ...
        // get filters from query parameter
        ...
        // sorting means in shop default sorting and many more 
        ...
        if(products.length > limit){
            nextPage = page + 1
            products.pop() // remove last element of array and return it or remove extra items
        }
