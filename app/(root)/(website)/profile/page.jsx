...
const [file, setFile] = useState()
  ...
  {({getRootProps, getInputProps}) => (
      <div {...getRootProps()}>
        <input {...getInputProps()} />
        <Avatar className='w-28 h-28 relative group border border-gray-500'>
      ...
      <FaCamera color='#7c3aed' />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input type="text" placeholder="Enter your phone no." {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                            ...
                            <div className='mb-3 md:col-span-2 col-span-1'> 
                                <ButtonLoading loading={loading} type="submit" text="Update Profile" className=" cursor-pointer" />
                            </div>
