        ...
        <div className="md:w-1/2 md:mt-0 mt-5 ">
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: decode(
                // (product.description = `Stylish pants designed with a modern fit and premium comfort, perfect for everyday wear.`),
                (product.description = `Upgrade your wardrobe with these stylish pants and shirts designed for a sharp fit, premium comfort, and effortless everyday style.`),
                (product.description = `Modern stylish pants with a comfortable fit, perfect for daily wear and special occasions.`),
                (product.description = `These stylish shirts combine premium fabric, a tailored fit, and modern design to give you a smart and confident appearance all day long.`),
                ...
                <div className="mt-5">
                  ...
                  type='button'
                  text='Add To Cart'                  
                  className="w-full rounded-full py-6 text-md cursor-pointer" onClick={handleAddToCart} />
                  :
