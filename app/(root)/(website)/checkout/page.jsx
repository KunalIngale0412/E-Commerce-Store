...
const Checkout = () => {
  ...
  // place order function will be here
...
const placeOrder = async (formData) => {
  ...
  try {
    ...
    "image": "https://res.cloudinary.com/dwj1k7x70/image/upload/v1770391379/logo-black_1_lijait.webp",
    "order_id": order_id, 
  ...
  return (
    <div>
        ...
        {savingOrder  && 
        <div className="h-screen w-screen fixed left-0 top-0 z-50 bg-black/10 ">
      ...
      {cart.count === 0 ? (
        <div className="w-screen h-[600px] flex justify-center items-center py-32">
        ...
        <div className="flex lg:flex-nowrap flex-wrap gap-10 my-20 lg:px-32 px-4 ">
          <div className="lg:w-[65%] w-full">
            ...
            <div className="flex font-semibold gap-2 items-center">
              <FaShippingFast size={28}  /> Shipping Address
            </div>
            <div className="mt-5">
            <Form {...orderForm}>
                      <form
                          ...
                          <td className="p-3">
                            <div className="flex items-center gap5">
                              ...
                              <div>
                                ...
                                {/* We can give className to the p tag as text-sm to make it small */}
