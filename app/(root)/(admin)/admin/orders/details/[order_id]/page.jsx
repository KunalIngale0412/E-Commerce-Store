        ...
        {!orderData ? 
          ...
          <div className="px-5 mb-5">
            <div className="mb-5">
              ...
              <p><b>Payment Id: </b> {orderData?.payment_id}</p>
                  ...
                  <tr key={product.variantId._id} className="md:table-row block border-b">
                    <td className="p-3 md:table-cell">
                      <div className="flex items-center gap-5">
                        <Image src={product?.variantId?.media[0]?.secure_url || imgPlaceholder.src} width={60} height={60} alt="Product" className="rounded" />
                    ...
                    <td className="md:table-cell flex justify-between mb-3 md:p-3 px-3 pb-2 text-center">
...
<hr />
                ...
                <div className="pt-3">
                  <h4 className="text-lg mb-2 font-semibold">Order Status</h4>
